...
- **`meso_pyramid_courtyard_v1`** genome + **`MESOAMERICAN_PYRAMID`** grammar (6 modules: retaining, stair, ramp, arcade, portal, pool)
- **`MESOAMERICAN_PYRAMID`** compose style — no tower spines; pillar corner, stair monument, fountain sacred
