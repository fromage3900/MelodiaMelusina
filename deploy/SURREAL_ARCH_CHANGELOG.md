...
- **`meso_pyramid_courtyard_v1`** genome + **`MESOAMERICAN_PYRAMID`** grammar (retaining, stair, ramp, colonnade, portal, pool)
- **`MESOAMERICAN_PYRAMID`** compose style — pillar corner marker, stair monument, fountain sacred (no tower spines)
- Research study + `meso_pyramid_courtyard_graph` + curated playable preset; `axis_compression`
- Library bake for retaining wall / stair / ramp; world manifest embed verify; catalog **31**
