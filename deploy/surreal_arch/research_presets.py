...
RESEARCH_PRESETS = {
    ...
    "art_deco_lobby_graph": {
        "label": "Art Deco Lobby Promenade",
        "description": "Geometric facade, panel wall, chevron filigree, cusped portal, promenade ramp",
        "research_ref": "research/artdeco/01_lobby_promenade.md — art_deco_lobby_v1 + ART_DECO graph (tower-ban)",
        "group": "CIVIC",
        "graph_id": "ART_DECO",
        "genome_id": "art_deco_lobby_v1",
        "props": dict(
            arch_type="BAROQUE_FACADE",
            baroque_facade_bays=3,
