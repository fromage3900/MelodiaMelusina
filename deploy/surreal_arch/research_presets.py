...
RESEARCH_PRESETS = {
    ...
    "art_deco_lobby_graph": {
        "label": "Art Deco Lobby Plaza",
        "description": "Setback facade, lobby stair, geometric panels, chevron filigree, colonnade, cusped portal, ramp, fountain",
        "research_ref": "research/artdeco/01_lobby_plaza.md — art_deco_lobby_v1 + ART_DECO horizontal civic graph",
        "group": "CIVIC",
        "graph_id": "ART_DECO",
