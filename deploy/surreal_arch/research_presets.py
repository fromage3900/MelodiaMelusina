...
RESEARCH_PRESETS = {
    ...
    "greek_stoa_graph": {
        "label": "Greek Stoa Colonnade",
        "description": "Hypostyle stoa hall, arcade colonnade, columns, processional stair, Roman propylon, agora fountain",
        "research_ref": "research/greek/01_stoa_colonnade.md — greek_stoa_v1 + GREEK_STOA graph",
        "group": "CIVIC",
        "graph_id": "GREEK_STOA",
        "genome_id": "greek_stoa_v1",
        "props": dict(
            arch_type="GREYBOX_PILLAR_HALL",
            gb_cols_x=4,
            gb_cols_y=2,
