...
RESEARCH_PRESETS = {
    ...
    "beaux_arts_plaza_graph": {
        "label": "Beaux-Arts Civic Plaza",
        "description": "Temple-front facade, ceremonial stair, ramp, colonnade, Roman portal, balustrade, fountain",
        "research_ref": "City Beautiful civic court — beaux_arts_plaza_v1 + BEAUX_ARTS_PLAZA graph",
        "group": "CIVIC",
        "graph_id": "BEAUX_ARTS_PLAZA",
        "genome_id": "beaux_arts_plaza_v1",
        "props": dict(
            arch_type="BAROQUE_FACADE",
            baroque_facade_bays=7,
            baroque_facade_height=14.0,
            baroque_order="CORINTHIAN",
            baroque_ornament_density=0.7,
            material_choice="MARBLE",
            unit_size=2.0,
            style_genome_id="beaux_arts_plaza_v1",
        ),
    },
