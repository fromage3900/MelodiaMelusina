...
RESEARCH_PRESETS = {
    ...
    "egyptian_temple_court_graph": {
        "label": "Egyptian Temple Court",
        "description": "Pylon flank, lintel gate, processional stair, hypostyle, peristyle arcade, ramp, sacred lake",
        "research_ref": "research/egyptian/01_temple_court.md — egyptian_temple_court_v1 + EGYPTIAN_TEMPLE_COURT graph",
        "group": "CIVIC",
        "graph_id": "EGYPTIAN_TEMPLE_COURT",
        "genome_id": "egyptian_temple_court_v1",
        "props": dict(
            arch_type="ARCHWAY_ADV",
            ...
            material_choice="STONE",
            unit_size=2.0,
            style_genome_id="egyptian_temple_court_v1",
        ),
    },
