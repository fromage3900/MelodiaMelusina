...
RESEARCH_PRESETS = {
    ...
    "ottoman_caravanserai_graph": {
        "label": "Ottoman Caravanserai",
        "description": "Han facade, horseshoe iwan, arabesque screen, riwaq arcade, stable corridor, gallery ramp, sahn fountain",
        "research_ref": "research/ottoman/01_caravanserai_courtyard.md — ottoman_caravanserai_v1 + OTTOMAN_CARAVANSERAI graph",
        "group": "CIVIC",
        "graph_id": "OTTOMAN_CARAVANSERAI",
        "genome_id": "ottoman_caravanserai_v1",
        "props": dict(
            arch_type="BAROQUE_FACADE",
            baroque_facade_bays=5,
            ...
            material_choice="STONE",
            unit_size=2.0,
            style_genome_id="ottoman_caravanserai_v1",
        ),
    },
