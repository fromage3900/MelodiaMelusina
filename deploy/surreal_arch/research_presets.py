...
RESEARCH_PRESETS = {
    ...
    "art_deco_lobby_graph": {
        ...
        "description": "Facade frontispiece, geometric panel wall, chevron filigree, cusped portal, approach ramp — no tower spines",
        "research_ref": "research/art_deco/01_lobby_promenade.md — art_deco_lobby_v1 + ART_DECO graph",
        "group": "CIVIC",
        "graph_id": "ART_DECO",
