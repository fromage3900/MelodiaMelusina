...
COMPOSE_STYLES = {
    ...
    "BALINESE_PURA_COURTYARD": {
        "large": "_lib_CN_TING_PAVILION",
        "medium": "_lib_GB_ROMANESQUE_ARCADE",
        "small": "_lib_PILLAR",
        "wall": "_lib_CURTAIN_WALL",
        "corner_tower": "_lib_PILLAR",
        "gate": "_lib_CN_MOON_GATE",
        "monument": "_lib_PUBLIC_FOUNTAIN",
        "sacred": "_lib_CN_TING_PAVILION",
    },
}
...
def compose_world(
    ...
    if world_root:
        ...
        elif style_key == "BALINESE_PURA_COURTYARD":
            world_root["surreal_style_genome_id"] = "balinese_pura_courtyard_v1"
        try:
