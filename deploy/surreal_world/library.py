...
SURREAL_LIBRARY_SPEC = {
    ...
    "GREYBOX_RAMP": {"gb_length": 8.0, "gb_width": 2.4, "gb_rise": 1.6, "material_choice": "STONE"},
    "GREYBOX_STAIR_BLOCK": {"gb_steps": 10, "gb_rise": 0.2, "gb_run": 0.34, "gb_width": 2.8, "material_choice": "STONE"},
}
