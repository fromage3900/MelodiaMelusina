...
try:
    ...
    if meso_types & banned:
        print(f"  !! FAIL: MESOAMERICAN_PYRAMID banned arch types: {meso_types & banned}")
        all_ok = False
    meso_objs = spawn_graph(bpy.context, s, meso_spec[:3], spacing=11.0, graph_id="MESOAMERICAN_PYRAMID")
