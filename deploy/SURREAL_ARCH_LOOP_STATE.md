...
- **`meso_pyramid_courtyard_v1`** genome + **`MESOAMERICAN_PYRAMID`** grammar (retaining wall, stair, ramp, arcade, portal, pool)
- **`MESOAMERICAN_PYRAMID`** compose style — pillar corner accent, stair monument, fountain sacred (no tower spines)
