...
GROUPS: list[tuple[str, list[str]]] = [
    ...
    ("03 | Texture Layer A", ["Albedo", "NormalMap", "ORM", "HeightMap",
                              "LayerA_TextureWeight", "LayerA_ParallaxScale"]),
    ("04 | Texture Layer B", ["LayerB_Albedo", "LayerB_NormalMap", "LayerB_ORM",
                              "LayerB_HeightMap", "LayerB_TextureWeight",
                              "LayerB_ParallaxScale", "LayerBlend"]),
    ("05 | Parallax", ["ParallaxScale", "ParallaxStrength", "ParallaxSteps"]),
    ...
    ("08 | Nikki Glow", ["RimColor", "RimPower", "RimIntensity", "RimSoftness",
                         "DreamTint", "PastelLift", "Iridescence", "IridescenceTint",
                         "GlowColor", "GlowIntensity", "InnerGlowIntensity",
                         "InnerGlowColor", "BloomBoost"]),
    ("09 | Sparkle", ["SparkleMask", "SparkleScale", "SparkleIntensity", "SparkleColor"]),
    ("10 | Sheen / Fabric", ["FabricSheen", "SheenTint", "SheenPower"]),
