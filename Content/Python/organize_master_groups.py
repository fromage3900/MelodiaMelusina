...
GROUPS: list[tuple[str, list[str]]] = [
    ...
    ("04 | Texture Layer B", ["LayerB_Albedo", "LayerB_NormalMap", "LayerB_ORM",
                              ...
                              "LayerBlendMode", "LayerHeightBias", "LayerHeightSharpness",
    ...
    ("12 | Shadow Garden (Flowers)", ["ShadowFlowerStrength", "ShadowFlowerScale",
                                      "ShadowFlowerScaleFine", "ShadowFlowerRotation",
                                      "ShadowFlowerJitter", "ShadowFlowerSoftness",
                                      "ShadowFlowerAlbedoDarken", "ShadowFlowerPulseStrength",
                                      "ShadowFlowerMask", "ShadowFlowerColor"]),
    ("13 | Shadow Dream", ["ShadowDreamTint", "ShadowDreamStrength", "ShadowSoftness",
                           "ShadowDreamHueShift", "ShadowDreamSaturation", "ShadowContactBoost",
                           "ShadowDreamAmbientMix", "ShadowDreamAmbientColor", "bShadowUseSceneLight"]),
    ...
    ("22 | Audio Reactivity", ["AudioReactivity", "BassWeight", "MidWeight", "TrebleWeight",
                               "AudioEmissiveStrength", "AudioRoughnessPulse",
                               "AudioLayerBlendPulse", "AudioTemporalPulse",
                               "BeatPhaseStrength", "bBeatLayerWipe"]),
]
